...
.CODE
    ...
    MOV DL, num1 ;moves 55H to AL
    NOT DL ;complement the content of accumulator AL
    INC DL ;add one to the content of accumulator
    
    MOV BL, DL ;move content of A to B
    MOV DL, num2 ;moves 10H to A
    ADD DL, BL ;subtract the content of B with content of A
    JC SKIP
    NOT DL
    INC DL
SKIP:
